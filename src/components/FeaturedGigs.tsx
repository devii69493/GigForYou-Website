  ...
  return (
    <section id="featured" className="py-24 bg-surface-dark/30">
      <div className="mx-auto max-w-7xl px-6">
        ...
        <div className="mt-12 flex gap-6 overflow-x-auto pb-4 snap-x snap-mandatory scrollbar-thin">
          {gigs.map((gig, i) => (
            <div
              key={i}
              className="gig-card-hover min-w-[320px] max-w-[320px] snap-start rounded-xl border border-border-subtle bg-surface-dark transition-all duration-300 flex-shrink-0"
            >
