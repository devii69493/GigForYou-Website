          ...
          <div className="relative overflow-hidden rounded-2xl bg-gradient-to-r from-electric-violet/90 to-violet-glow/60 px-8 py-16 text-center sm:px-16 sm:py-24">
            ...
            <div className="relative z-10">
              ...
              <div className="mt-8 flex flex-col items-center gap-4 sm:flex-row sm:justify-center">
                <a
                  href="#"
                  className="inline-flex w-full items-center justify-center gap-2 rounded-xl bg-pure-white px-8 py-4 text-base font-semibold text-electric-violet transition-all hover:bg-pure-white/90 hover:shadow-xl sm:w-auto"
                >
                  Create Your Free Account
                  <span>&rarr;</span>
                </a>
              </div>
              <p className="mt-4 text-sm text-pure-white/60">
                No credit card required &middot; Free forever to join
              </p>
            </div>
          </div>
        </AnimateOnScroll>
