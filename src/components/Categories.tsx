        ...
        <div className="mt-14 grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4">
          {categories.map((cat) => (
            <a
              key={cat.name}
              href="#"
              className="group rounded-xl border border-border-subtle bg-surface-dark p-6 transition-all duration-300 hover:border-electric-violet/50 hover:shadow-lg hover:shadow-electric-violet/5"
            >
